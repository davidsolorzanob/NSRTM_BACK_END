...
public class DocSustentoContribuyenteCustomRepositoryImpl implements DocSustentoContribuyenteCustomRepository  {
    ...
    @Override
    public List<DocSustentoContribuyente> CrearContactoLista(Long municipalidadId, Long contribuyenteNumero, List<DocSustentoContribuyente> lista) {
    ...
    @Override
    public boolean EliminarDocSustento(Long municipalidadId, Long contribuyenteNumero, Long docSustentoId, Long usuarioRegistro, String terminalRegistro) {
